...
describe('apiCalls', () => {
  ...
  describe('getLocation', () => {
    ...
    it('should return an error', () => {
      ...
      expect(getLocation('Mountain View', 'CA')).rejects.toEqual(Error('Failed to get coordinates'));
    });

    it('should return an error if the promise rejects', () => {
      window.fetch = jest.fn().mockImplementation(() => {
        return Promise.reject(Error('Failed to get coordinates'))
      });
  ...
  describe('getEventsByLocation', () => {
    ...
    it('should be called with correct params', () => {
      getEventsByLocation(12345, -12345)
      expect(window.fetch).toBeCalledWith('https://api.predicthq.com/v1/events/?within=20mi@12345,-12345/', options)
    });
  
    it('should return a successful response', () => {
      expect(getEventsByLocation(12345, -12345)).resolves.toEqual(mockResponse);
    });
    ...
    it('should return an error', () => {
      ...
      expect(getEventsByLocation(12345, -12345)).rejects.toEqual(Error('Failed to get event from coordinates'));
    });

    it('should return an error if the promise rejects', () => {
      window.fetch = jest.fn().mockImplementation(() => {
        return Promise.reject(Error('Failed to get event from coordinates'))
      });
