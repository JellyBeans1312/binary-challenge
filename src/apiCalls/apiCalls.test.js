...
describe('apiCalls', () => {
  ...
  describe('getAddress', () => {
    ...
    it('should be called with the correct params', () => {
        getAddress('Mountain View', 'CA')
        expect(window.fetch).toBeCalledWith('https://maps.googleapis.com/maps/api/geocode/json?latlng=Mountain View,CA&key=AIzaSyDPPlNyjATG8sQnfsdg45ln7kUoyFH24m0')
    });

    it('should return a successful response', () => {
      expect(getAddress('Mountain View', 'CA')).resolves.toEqual(mockResponse);
    });
    ...
    it('should return an error', () => {
      ...
      expect(getAddress('Denver', 'CO')).rejects.toEqual(Error('Failed to find address'));
    });
    ...
    it('should return an error if the promise rejects', () => {
      ...
      expect(searchEvent('jid')).rejects.toEqual(Error('Failed to find address'))
    });
  })
